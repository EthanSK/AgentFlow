...
struct DashboardContent: View {
        ...
        VStack(spacing: 10) {
            HStack {
                ...
                if hasLoadedStatsSnapshot {
                    ...
                    Text("You have saved \(highlightedTime) with Agent Flow")
                        .fontWeight(.bold)
                        .foregroundColor(.white.opacity(0.85))
                        .font(.system(size: 30))
                        .multilineTextAlignment(.center)
                } else {
                    Text("Agent Flow Insights")
    ...
    private var voiceInkStatsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            DashboardStatCard(
                ...
                detail: "Agent Flow sessions completed",
            ...
            DashboardStatCard(
                ...
                value: hasLoadedStatsSnapshot && averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "Agent Flow vs. typing by hand",
    ...
    private var heroSubtitle: String {
        ...
        guard totalCount > 0 else {
            return String(localized: "Your Agent Flow journey starts with your first recording.")
        }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text("Required for Agent Flow shortcuts and app-wide controls to work properly.")
                    .font(.system(size: 11))

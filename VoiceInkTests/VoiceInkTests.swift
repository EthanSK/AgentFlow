...
struct VoiceInkTests {
    ...
    @Test func retryUsesRetiredFailureAndNormalQueueWithoutStartingCapture() throws {
        ...
        #expect(retry.contains("preservesOriginalAudioForRecovery: false"))
        ...
        #expect(engine.contains("identity.generation == self.transcriptionJobRegistry.generation"))
        #expect(engine.contains("let shouldPresentFailure = jobIsCurrent() && !jobShouldCancel()"))
